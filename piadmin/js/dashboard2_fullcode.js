var cppDashboard2Analysis=[
            {
                ...
                "path":"path={0}|CPP540&path={0}|CPP600&path={0}|TPP600",
   ...
   var rankingElements1 = [];
    var batch1 = {
        "database": {
            "Method": "GET",
            "Resource": baseServiceUrl + "elements?path=\\\\" + afServerName + "\\" + afDatabaseName + "\\KPIs\\DASHBOARD-2\\" + cppDashboard2Analysis[key].title + "&selectedFields=WebId;Name;Path;Links.Elements"
        },
        "elements": {
            "Method": "GET",
    ...
    $.when(batchResult1).done(function() {
        ...
        $.each(batchResultItems, function(elementID) {
            ...
            var elementItems1 = [{"mw": elementName1 },{"UOM":UO}];
            attrItems.forEach(function(attr, attrID) {
                ...
                if (attr !== undefined && attr.Object !== undefined) {
                  ...
                  if(attrName1 =='Unit-1'){  elementItems1.push({'one': attrValue});//FIRST
                  }else if(attrName1 =='Unit-2'){elementItems1.push({'two': attrValue});
                  }else if(attrName1 =='Unit-3'){elementItems1.push({'three': attrValue});
                  }else if(attrName1 =='Unit-4'){elementItems1.push({'four': attrValue});
                          
                  }else if(attrName1 =='PM'){elementItems1.push({'PM': attrValue});//SECOND
                  }else if(attrName1 =='NOx'){elementItems1.push({'NOx': attrValue});
                  }else if(attrName1 =='SOx'){elementItems1.push({'SOx': attrValue});
                          
                  }else if(attrName1 =='CPP540'){elementItems1.push({'CPP540': attrValue});//THIRD
                  }else if(attrName1 =='CPP600'){elementItems1.push({'CPP600': attrValue});
                  }else if(attrName1 =='TPP600'){elementItems1.push({'TPP600': attrValue});
                  }else if(attrName1 =='IPP600'){elementItems1.push({'IPP600': attrValue});
                  }
                valuesID++;
            });
       ...
       var t= $('#'+cppDashboard2Analysis[key].table).DataTable();
        $.each(rankingElements1, function (key) {
                ...
                }else if(rankingElements1[key][2].PM){
               ...
               }else if(rankingElements1[key][4].TPP600){
                        rows2.push(rankingElements1[key][0].mw,rankingElements1[key][1].UOM, rankingElements1[key][2].CPP540,rankingElements1[key][3].CPP600,rankingElements1[key][4].TPP600);
                }else if(rankingElements1[key][4].CPP600){
